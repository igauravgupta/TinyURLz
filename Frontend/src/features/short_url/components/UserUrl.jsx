...
import { getAllUserUrls} from '../../auth/services/auth.api.js'
import { deleteShortUrl } from '../services/short_url.api.js'
...
const UserUrl = () => {
  ...
  // Fix: Check if urls is defined before accessing urls.urls
              ...
              <tr key={url._id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm font-medium flex gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200"
                  >
                    <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
